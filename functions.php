...
add_action('wp_enqueue_scripts', 'zenith_scripts', 100);
function zenith_scripts(){
  ...
  wp_register_script(
    'zenith-scripts', 
    get_template_directory_uri() . '/js/zenith-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('zenith-scripts');  
}

add_action('wp_enqueue_scripts', 'zenith_styles');
function zenith_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('zenith', get_template_directory_uri() . '/style.css');
